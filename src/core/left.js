    ...
    return (
      <Plus4U5.App.Left
        ...
        logoProps={{
          ...
          title: 'uuJokes',
          companyLogo: Plus4U5.Environment.basePath +
            'assets/img/unicorn-logo.svg',
          generation: '1',
        }}
        aboutItems={[
          {content: <UU5.Bricks.Lsi lsi={Lsi.left.about} />, href: 'about'},
        ]}
        helpHref={null}
      >
        <Plus4U5.App.MenuTree
          ...
          items={[
            ...
            },
            {
              id: 'jokes',
              href: 'jokes',
              content: <UU5.Bricks.Lsi lsi={Lsi.left.jokes} />,
            },
          ]}
        />
      </Plus4U5.App.Left>

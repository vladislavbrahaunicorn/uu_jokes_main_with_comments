...
const FileLinkEditable = UU5.Common.Component.lazy(async () => {
  ...
  return import("./file-link-editable.js");
});
//@@viewOff:imports

//@@viewOn:statics
const STATICS = {
  displayName: Cfg.tag("Links.FileLink")
};
//@@viewOff:statics
const { id, className, style, mainAttrs, noIndex, ...defaultProps } = FileLinkView.defaultProps;
...
const FileLink = createComponent({
  ...
  //@@viewOn:propTypes
  propTypes: FileLinkView.propTypes,
  //@@viewOff:propTypes

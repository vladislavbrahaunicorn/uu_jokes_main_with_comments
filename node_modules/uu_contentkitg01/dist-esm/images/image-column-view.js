...
//@@viewOn:statics
const STATICS = {
  displayName: Cfg.tag("Images.ImageColumnView")
};
//@@viewOff:statics

const ImageColumnView = createComponent({
  ...STATICS,
  ...
  propTypes: {
    ...
    alignment: UU5.PropTypes.oneOf(["block", "top", "center", "bottom"]),

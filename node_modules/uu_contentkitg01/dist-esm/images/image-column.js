...
import ImageColumnView from "./image-column-view.js";
import LazyLibraries from "../core/lazy-libraries";
const ImageColumnEditable = UU5.Common.Component.lazy(async () => {
  ...
  return import("./image-column-editable.js");
});
//@@viewOff:imports

//@@viewOn:statics
const STATICS = {
  displayName: Cfg.tag("Images.ImageColumn")
};
//@@viewOff:statics
const { id, className, style, mainAttrs, noIndex, ...defaultProps } = ImageColumnView.defaultProps;

const ImageColumn = createComponent({
  ...STATICS,
  ...
  //@@viewOn:propTypes
  propTypes: ImageColumnView.propTypes,
  //@@viewOff:propTypes

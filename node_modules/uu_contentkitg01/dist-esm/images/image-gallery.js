...
const ImageGalleryEditable = UU5.Common.Component.lazy(async () => {
  ...
  return import("./image-gallery-editable.js");
});
//@@viewOff:imports
...
//@@viewOff:statics
const { id, className, style, mainAttrs, noIndex, ...defaultProps } = ImageGalleryView.defaultProps;

const ImageGallery = createComponent({
  ...STATICS,
  ...
  //@@viewOn:propTypes
  propTypes: ImageGalleryView.propTypes,
  //@@viewOff:propTypes

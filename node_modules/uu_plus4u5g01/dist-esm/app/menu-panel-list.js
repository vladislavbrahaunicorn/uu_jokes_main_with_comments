...
import ListMenuItem from "./internal/list-menu-item.js";
...
export const MenuPanelList = UU5.Common.VisualComponent.create({
  //@@viewOn:mixins
  ...
  //@@viewOn:statics
  statics: {
    tagName: Cfg.TAG + "MenuPanelList",
    classNames: {
      main: props => {
        let classNames = [Cfg.CSS + "menu-panel-list"];
  ...
  _renderItems() {
    return this.props.items.map((itemProps, index) => (
      <ListMenuItem {...itemProps} id={itemProps.id} key={index} onClick={itemProps.onClick} />
    ));
  },

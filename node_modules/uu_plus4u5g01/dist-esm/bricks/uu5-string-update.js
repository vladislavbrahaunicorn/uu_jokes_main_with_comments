...
import "./uu5-string-update.css";

export const Uu5StringUpdate = UU5.Common.VisualComponent.create({
  //@@viewOn:mixins
  ...
  _validate() {
    ...
    let result;
    if (value && !UU5.Common.UU5String.isValid("<uu5string/>" + value)) {
      result = false;
    } else {

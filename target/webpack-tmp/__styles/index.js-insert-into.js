function insert(styleEl) {
  ...
  styleEl.setAttribute("data-owner", "uu_jokes_maing01-hi/uu_jokes_maing01-hi@0.1.0");
  styleEl.setAttribute("data-emotion", "uujokes");
  styleEl.setAttribute("data-tech", "less");

  // insert the style element
  // 1. after last matching data-emotion using technology "less"
  let els = insertionEl.querySelectorAll(`style[data-emotion="uujokes"]`);
